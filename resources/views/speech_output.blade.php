   ...
   <body class="main-layout">
      ...
      <div id="contact" class="contact">
         ...
         <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <form class="main_form" action="/recommend" target="_blank">
                        @csrf
                        <div class="row">
                            <div class="col-md-12 ">
                                <div class="titlepage">
                                    <input type="hidden" name="emotion" value="{{key($result7)}}">
                                    <h3> Given Input</h3>
                                    <p>{{$input}}</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <button type="submit" class="btn btn-primary">Recommendations</button>
                            </div>
                        </div>
                    </form>
                </div>
